...
// https://github.com/pspdev/pspsdk/blob/master/src/gu/guInternal.h
enum SceGeCommand {
    /* No operation */
    NOP = 0x0,
    /* Vertex data */
...
constexpr auto ToTextureFormat(uint32_t value) -> SceGuFmtTexture {
    if (value >= eSceGuFmtTextureCOUNT) {
        return eSceGuFmtTextureNONE;
    }
    return static_cast<SceGuFmtTexture>(value);
}

constexpr auto ToColorFormat(uint32_t value) -> SceGuFmtColor {
    if (value < eSceGuFmtColorPF5650 || value >= eSceGuFmtColorCOUNT) {
        return eSceGuFmtColorNONE;
    }
    return static_cast<SceGuFmtColor>(value);
}

constexpr auto ToNormalFormat(uint32_t value) -> SceGuFmtNormal {
    if (value >= eSceGuFmtNormalCOUNT) {
        return eSceGuFmtNormalNONE;
    }
    return static_cast<SceGuFmtNormal>(value);
}

constexpr auto ToVertexFormat(uint32_t value) -> SceGuFmtVertex {
    if (value >= eSceGuFmtVertexCOUNT) {
        return eSceGuFmtVertexNONE;
    }
    return static_cast<SceGuFmtVertex>(value);
}

constexpr auto ToWeightFormat(uint32_t value) -> SceGuFmtWeight {
    if (value >= eSceGuFmtWeightCOUNT) {
        return eSceGuFmtWeightNONE;
    }
    return static_cast<SceGuFmtWeight>(value);
}

constexpr auto ToIndexFormat(uint32_t value) -> SceGuFmtIndex {
    if (value >= eSceGuFmtIndexCOUNT) {
        return eSceGuFmtIndexNONE;
    }
    return static_cast<SceGuFmtIndex>(value);
}
...
constexpr auto ColorPF5650ToRGBA8(uint16_t color) -> glm::fvec4 {
...
constexpr auto ColorPF5551ToRGBA8(uint16_t color) -> glm::fvec4 {
    const auto r = uint16_t{0b0000000000011111} & color;
...
constexpr auto ColorPF4444ToRGBA8(uint16_t color) -> glm::fvec4 {
...
constexpr auto ColorPF8888ToRGBA8(uint32_t color) -> glm::fvec4 {
